...
dict_of_args = args.__dict__

dict_of_args['data_dir'] = '/content/content/all_ones_final'
dict_of_args['dataset'] = 'posluna'
dict_of_args['exp'] = 'exp1'
dict_of_args['image_size'] = 64
dict_of_args['num_channels'] = 1
dict_of_args['num_channels_dae'] = 128
dict_of_args['num_timesteps'] = 1
dict_of_args['num_res_blocks'] = 2
dict_of_args['batch_size'] = 16
dict_of_args['num_epoch'] = 42
dict_of_args['ngf'] = 64
dict_of_args['nz'] = 100

dict_of_args['z_emb_dim'] = 256
dict_of_args['n_mlp'] = 4
dict_of_args['embedding_type'] = 'positional'

#dict_of_args['beta1'] = 0.2
#dict_of_args['beta2'] = 0.6

dict_of_args['ema_decay'] = 0.9999
dict_of_args['r1_gamma'] = 0.02
dict_of_args['lr_g'] =  1.5e-4
dict_of_args['lr_d'] = 1e-4
dict_of_args['lazy_reg'] = 10
dict_of_args['num_process_per_node'] = 1
dict_of_args['ch_mult'] = [1,2,2,2]
dict_of_args['resume'] = True
dict_of_args['save_content'] = True
dict_of_args['save_content_every'] = 1
dict_of_args['save_ckpt_every'] = 1
#dict_of_args[''] = 

args.__dict__ = dict_of_args
