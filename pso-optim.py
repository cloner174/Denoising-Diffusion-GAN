...
def evaluate(hyperparams: Dict, seed: int) -> float:
    """
    Evaluate the given hyperparameters by training the GAN and computing the score based on G and D losses.
    ...
    Returns:
        float: Computed score (lower is better).
    """
